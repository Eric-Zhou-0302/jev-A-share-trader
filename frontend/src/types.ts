...
export interface Job { id: string; scope: string; status: string; phase: string; total: number; downloaded: number; completed: number; failed: number; skipped: number; remaining: number; as_of: string | null; error?: Notice | null; items?: JobItem[] }
