...
export default function App() {
  ...
  return <div className="app-shell">
    <aside className="sidebar">
      ...
      <div className="sidebar-bottom"><span className="local-indicator"><i/>{t('local')}</span><button onClick={() => setSettingsOpen(true)} disabled={!settings}><Settings2 size={17}/>{t('settings')}</button><p>JEV RESEARCH WORKSPACE<span>v0.1.0</span></p></div>
    </aside>
